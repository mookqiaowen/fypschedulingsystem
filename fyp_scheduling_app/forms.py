...
from fyp_scheduling_app.models import Courses, SessionYearModel
...
class AddStudentForm(forms.Form):
    ...
    fyp_title=forms.CharField(label="FYP Title", max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    supervisor=forms.CharField(label="Supervisor", max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
    moderator=forms.CharField(label="Moderator", max_length=50,widget=forms.TextInput(attrs={"class":"form-control"}))
